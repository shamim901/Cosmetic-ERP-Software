...
Route::group(['namespace' => 'Librarys'], function () {
	...
	Route::group(['middleware' => 'auth'], function () {
		...
		Route::get('library/authentic/{library_id}', 'LibrarysController@authentic');
		Route::get('library/authentic_cancel/{library_id}', 'LibrarysController@authentic_cancel');
		...
		Route::get('library/bn2enNumber/{id}','LibrarysController@bn2enNumber')->name('library.bn2enNumber');
