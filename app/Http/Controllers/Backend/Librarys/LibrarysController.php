...
namespace App\Http\Controllers\Backend\Librarys;
...
class LibrarysController extends Controller
{
    ...
    public function index()
    {
        ...
        $library= DB::table('librarys')
                    ...
                    ->select('librarys.*', 'divisions.bn_name as div_name', 'districts.bn_name as dis_name', 'upazilas.bn_name as up_name','unions.bn_name as un_name')->get();
        return view('backend.library.index', compact('library','division'));
    }
    ...
    {
        $division=DB::table('divisions')->get();
        return view('backend.library.create', compact('division'));
    }
    ...
    public function searchPanel(Request $request)
    {
        ...
        $library= DB::table('librarys')
                    ...
                    ->join('unions', 'librarys.union_id', '=', 'unions.id')
                    // ->join('villages', 'library_applications.village_id', '=', 'villages.id')
                    ->select('librarys.*', 'divisions.bn_name as div_name', 'districts.bn_name as dis_name', 'upazilas.bn_name as up_name','unions.bn_name as un_name')
                    ->where($condition)->get();
