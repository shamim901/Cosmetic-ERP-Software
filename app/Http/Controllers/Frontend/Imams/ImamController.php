...
class ImamController extends Controller
{
    ...
    public function trainingRegistration($id){
        ...
        $imam_info = DB::table('imam_registraions')
                    ...
                    ->join('training_experiences', 'imam_registraions.id', '=', 'training_experiences.imam_reg_num','left')
    ...
    public function saveKhotibInfo(Request $request){
       ...
       $khotib = DB::table('khotib_registration')
        ...
        $khotib_id = DB::getPdo()->lastInsertId();
    ...
    public function edit($id){
        ...
        return view('frontend.imam.editImamForm',compact('division','imam_info','mosques','training_list','batch_list','districts','upazilas'));        
    }
