...
mix.sass('resources/assets/sass/frontend/app.scss', 'public/css/frontend.css')
    ...
    .js([
        ...
        'resources/assets/js/frontend/imam_training.js',
        'resources/assets/js/frontend/mosque.js',
        'resources/assets/js/frontend/library.js',
    ...
    .js([
        ...
        'resources/assets/js/frontend/library.js',
        // 'public/js/plugins/autocomplete/autocomplete.js',
        'resources/assets/js/plugin/sweetalert/sweetalert.min.js',
        'resources/assets/js/plugins.js'
    ...
    .scripts([
        ...
        'resources/assets/js/backend/books.js',
        'resources/assets/js/backend/sale.js',
        'resources/assets/js/backend/employee.js',
        'resources/assets/js/global.js',
        'resources/assets/js/backend/requisition.js',
