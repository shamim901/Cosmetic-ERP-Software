                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($info as $key => $item)
                                <tr>
                                    ...
                                    <input type="text" class="form-control" size="1" name="op_balance" value="{{ $item->quantity_level}}" id="op_balance">
                                   
                                    </td>
                                    <td>

                                    {{ Form::open(['route' => 'admin.product.opening_balance_update', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-menu', 'files' => false]) }}
