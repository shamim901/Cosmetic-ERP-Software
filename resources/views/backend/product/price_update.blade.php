...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" style="padding: 0px 100px 0px 100px">
 ...
 <div class="row">
   {{ Form::open(['route' => 'admin.product.price_update', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-menu', 'files' => false]) }}
        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-home"></i> Update Opening Balance
                </div>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>                                    
                                    ...
                                    <td class="text-center">Set Price</td>
                                    <td>#</td>
                            ...
                            @foreach($info as $key => $item)
                                <tr>
                                    ...
                                    <input type="text" class="form-control text-center" size="1" name="op_balance" value="{{ $item->price}}" id="op_balance">
                                    ...
                                    {{ Form::open(['route' => 'admin.product.price_update', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-menu', 'files' => false]) }}
                                     ...
                                     <input type="hidden" class="form-control op_value" size="1" name="op_value" value="{{ $item->quantity_level}}" id="op_value">
