        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <select name="division" id="division" class="form-control box-size" >
                            <option value=""></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <select name="district" id="district" class="form-control box-size  district_val">
                            <option value=""></option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <select name="upazila" id="upazila" class="form-control box-size  upazila_val" >
                            <option value=""></option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <select name="union" id="union" class="form-control box-size  union_val" >
                            <option value=""></option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('email', null, ['class' => 'form-control box-size', 'required' => 'required']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('username', null, ['class' => 'form-control box-size', 'required' => 'required']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                ...
                <div class="form-group">
                 ...
                 <!-- <div class="form-group">
                    <label for="emp_role" class="col-lg-2 control-label">Role</label>
                    <div class="col-lg-10">
                        <select name="emp_role" id="emp_role" class="form-control box-size" >
                            <option value=""></option>
                            @foreach($emp_role as $item)
                   ...
                   <div class="form-group">
                    <label for="book_sellers" class="col-lg-2 control-label">Sale Centre</label>
                    <div class="col-lg-10">
                        <select name="book_sellers" id="book_sellers" class="form-control box-size" >
                            <option value=""></option>
                            @foreach($book_sellers as $item)
                                <option value="{{ $item->id }}">
                                    {{
                                      $item->name
                                    }}
