...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" style="padding: 0px 100px 0px 100px">
 ...
 <div class="row">
    {{ Form::open(['route' => 'frontend.library.pending_list', 'class' => '','id'=>'']) }}
        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-home"></i> পাঠাগার জরিপ তালিকা 
                </div>
                	...
                	<div class="">
                		<table class="table table-bordered">
            				...
            				@foreach($library as $key => $item)
            					<tr>
            						<td  class="text-center">{{ $item->mosque_name}}</td>
            						<td class="text-center">{{ $item->mosjid_establish_year}}</td>
