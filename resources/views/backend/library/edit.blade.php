						    ...
						    <tr>
						      	...
						      	<th>
					                <div class="form-group">
					                  ...
					                  <input type="number" value="{{ $library->total_books_by_ifa}}" name="total_books_by_ifa" id="total_books_by_ifa" class="form-control required clear books">
					                </div>
						    ...
						    <tr>
						      	...
						      	<th>
					                <div class="form-group">
					                  ...
					                  <input type="number" name="total_books_by_other" value="{{ $library->total_books_by_other}}" id="total_books_by_other" class="form-control required clear books">
					                </div>
						    ...
						    <tr>
						      	...
						      	<th>
					                <div class="form-group">
					                  ...
					                  <input type="number" name="total_books" value="{{ $library->total_books}}" id="total_books" readonly class="form-control required clear">
					                </div>
