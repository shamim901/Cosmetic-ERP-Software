        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-home"></i>  সর্বোচ্চ বিক্রেতার প্রতিবেদন 
                </div>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>                                  
                                    ...
                                    <td class="text-center"> মোট বিক্রি </td>
                                    <td class="text-center"> মোট টাকা </td>
                            ...
                            @foreach($info as $key => $item)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $item->tot_sale}}</td>
