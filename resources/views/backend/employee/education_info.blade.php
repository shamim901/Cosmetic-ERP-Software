...
<fieldset class="box box-primary box-body">		
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-12">
        ...
        <div class=" col-sm-3 col-md-3 col-lg-3">
            ...
            <div class="form-group ">
                ...
                <input type='text' class="form-control bn_language" name='emp_personal_id' id='emp_personal_id' value=" " maxlength="100"  tabindex="2"  required="" />
                <span class='help-inline'> </span>
            </div>	
        </div>	
        ...
        <div class=" col-sm-3 col-md-3 col-lg-3">
            ...
            <div class="form-group ">
                ...
                <input type='text' class="form-control" name='hrm_employee_father' id='hrm_employee_father'  value=" " required="" maxlength="100" tabindex="3"/>
                <span class='help-inline'> </span>
            </div>
        </div>
        ...
        <div class=" col-sm-3 col-md-3 col-lg-3">
            ...
            <div class="form-group ">
                ...
                <input type='text' class="form-control bn_language" name='employee_father_bengali' id='employee_father_bengali'  value=" " maxlength="100" tabindex="4" required=""/>
                <span class='help-inline'></span>
            </div>
        </div>
        ...
        <div class=" col-sm-3 col-md-3 col-lg-3">	
            ...
            <div class="form-group ">
                <label> মায়ের নাম (ইন্রেজিতে) </label>
                <input type='text' class="form-control" name='hrm_employee_mother' id='hrm_employee_mother' value="" required=""  maxlength="100" tabindex="5"/>
                <span class='help-inline'> </span>
            </div>	
        </div>
        ...
        <div class=" col-sm-3 col-md-3 col-lg-3">
            ...
            <div class="form-group ">
                ...
                <input type='text' class="form-control bn_language" name='employee_mother_bengali' id='employee_mother_bengali' value=" " maxlength="100" tabindex="6" required=""/>
                <span class='help-inline'> </span>
            </div>	
        </div>	
        ...
        <div class=" col-sm-3 col-md-3 col-lg-3">
            ...
            <div class="form-group ">						
                ...
                <select class="form-control" name="hrm_blood_group" id="hrm_blood_group" tabindex="11">
                    ...
                    //         if ($employee_details['EMP_BLOOD_GROUP'] == $key) {
                    //             echo "selected ";
                    //         }
                    //     }
                    //     echo ">" . $val . "</option>";
    ...
    <!--     <div class=" col-sm-3 col-md-3 col-lg-3">	
        ...
        <div class=" col-sm-3 col-md-3 col-lg-3">
            ...
            <div class="form-group ">						
                ...
                <input type="text" class="form-control datepickerCommon" name="employee_joining_date" id="employee_joining_date" value=" " title="" required="" tabindex="21"/>
                <span class='help-inline'> </span>
            </div>	
        </div>
    ...
    <div class=" col-sm-3 col-md-3 col-lg-3">
        ...
        <div class="form-group">
            <label> কৌটা</label>
            <select name="quota_id" id="quota_id" class="form-control" required="" tabindex="25" onchange="showDivs()">
