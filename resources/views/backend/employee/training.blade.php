...
{{ Form::open(['route' => 'admin.employee.saveTraining', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-menu', 'files' => false]) }}
 ...
 -->
        ...
        <div class="col-sm-6 col-md-6 col-lg-6">
            ...
            <div class="col-md-6 col-sm-6 col-lg-6">
                <div class="form-group  ">
                    <label> মোবাইল</label>
                    <input type='text' class="form-control bn_language" name='employee_alternative_mobile_no' id='employee_alternative_mobile_no' maxlength="15" value="  " />
                    <span class='help-inline'> </span>
                </div>
                </div>
