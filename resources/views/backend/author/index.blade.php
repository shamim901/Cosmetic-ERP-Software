...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" style="padding: 0px 100px 0px 100px">
 ...
 <div class="row">
   {{ Form::open(['route' => 'admin.author.search', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-menu', 'files' => false]) }}
        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-home"></i>   লেখকের তালিকা 
                </div>
                            ...
                            @foreach($info as $key => $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <!-- <a href="{{route('admin.bseller.update',$item->id)}}" class="btn">Edit</a> -->
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
