...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" style="padding: 0px 100px 0px 100px">
 ...
 <div class="row">
    {{ Form::open(['route' => 'frontend.imam.showImamList', 'class' => '','id'=>'']) }}
   ...
   <select name="district_id" id="district" class="district_val form-control required">
    ...
    <input type="text" name="nid" placeholder=" জাতীয় পরিচয়পত্র নং " class="form-control">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <td class="text-center"> জাতীয় পরিচয়পত্র নং </td>
                            ...
                            @foreach($imam_info as $key => $item)
                                <tr>
                                    ...
                                    <td class="text-center"> 
                                        <a href="/imam/edit/{{$item->id }}" class="btn">Edit </a>
                                    </td> 
                                     @endif
                                    <td class="text-center">
