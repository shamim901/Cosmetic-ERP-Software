...
@section('content')
{{ Form::open(['route' => 'frontend.imam.saveKhotibInfo', 'class' => '','id'=>'']) }}
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <h3> <b>অনলাইন খতিব  আবেদন ফর্ম </b></h3>
                ...
                <div class="panel-body">
						...
						<colgroup>
					  	...
					  	<thead>
					    	<tr class="success">
						      	<th class="text-center" colspan="6"> খতিবের তথ্য: </th>
						    </tr>
					  	</thead>
					  	<tbody>
                	...
                	<table class="table table-bordered">
						<colgroup>
					  	...
					  	<thead>
					    	<tr class="success">
						      	<th class="text-center" colspan="6"> খতিবের বাসস্থান:</th>
						    </tr>
					  	</thead>
					  	<tbody>
						    <tr>
...
<!-- 				<table class="table table-bordered">
 ...
 -->
                      ...
                      <table class="table table-bordered" id="education_table" style="margin-bottom:0px; ">
                        <thead>
					    	<tr class="success">
						      	<th class="text-center" colspan="9"> খতিবের শিক্ষাগত যোগ্যতা:</th>
						    </tr>
					  	</thead>
                            <thead>
                            <tr class="active">
