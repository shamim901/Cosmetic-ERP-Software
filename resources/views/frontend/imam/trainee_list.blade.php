...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" style="padding: 0px 100px 0px 100px">
 ...
 <div class="row">
    {{ Form::open(['route' => 'frontend.imam.imam_trainee_req_list', 'class' => '','id'=>'']) }}
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    @if ($logged_in_user) <td class="text-center" colspan="3">Action</td>
                                      @endif
                                   <!--  <td class="text-center"></td>
                                    <td class="text-center"></td> -->
                            ...
                            @foreach($imam_info as $key => $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/train/approve/{{$item->id }}" class="btn"> Approved </a>
                                    </td>
                                    ...
                                    <td class="text-center"> 
                                        <a href="/train/delete/{{$item->id }}" class="btn"> Delete </a>
                                    </td>
                                      @endif
                                </tr>
                            @endforeach
