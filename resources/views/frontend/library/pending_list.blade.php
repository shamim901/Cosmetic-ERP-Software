            ...
            <div class="panel panel-default">
                 <div style="width: 100%" style="display: inline-block;">
                    ...
                    <div  class="panel-heading" style="width: 40%; float: left;">
                       <i class="fa fa-home"></i> পাঠাগার জরিপ তালিকা (অপেক্ষামান)
                    </div>

                    <div class="panel-heading" style="width: 60%;float: right;text-align: right;" >
                        <h3> <b> <a href="/library/create" class="btn btn-success">New</a> </b></h3>             
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <!-- <td><a href="/library/printView/{{$item->id }}"><i class="fa fa-print"></i></a></td> -->
                                      <td class="text-center">
                                        <a href="/library/authentic/{{$item->id }}" class="btn"> Approved </a>
                                    </td>

                                    <td class="text-center">
                                     <a href="/library/authentic_cancel/{{$item->id }}" class="btn"> Cancel </a> 
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
